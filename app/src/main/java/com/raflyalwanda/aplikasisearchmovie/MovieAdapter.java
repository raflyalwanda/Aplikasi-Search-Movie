...
public class MovieAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.tv_movieTitle = convertView.findViewById(R.id.tv_movieTitle);
            holder.tv_descMovie = convertView.findViewById(R.id.tv_descMovie);
            holder.tv_dateMovie = convertView.findViewById(R.id.tv_dateMovie);
        ...
        Picasso.with(context).load("https://image.tmdb.org/t/p/w342/" + mData.get(position).getPoster_path()).placeholder(context.getResources().getDrawable(R.drawable.ic_link_black_24dp)).error(context.getResources().getDrawable(R.drawable.ic_link_black_24dp)).into(holder.ivThumbnail);
        return convertView;
    }
